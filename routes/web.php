...
Route::middleware(['auth', 'isSupAdmin'])->group(function () {
    ...
    Route::view('/Reporte-Solicitudes-AcepDene', 'reportes.soli-acep-dene')->name('reporteSoliAcpDen');
    Route::view('/Promedio-Aceptacion-Productos', 'reportes.grafica-aceptacion')->name('graficaAcep');
});
